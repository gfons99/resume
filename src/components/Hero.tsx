      ...
      <div className="max-w-6xl mx-auto z-10 w-full">
        <div className="grid grid-cols-2 lg:grid-cols-[1fr_auto] gap-x-4 sm:gap-x-8 lg:gap-x-16 gap-y-6 sm:gap-y-8 items-start">
          ...
          <div className="col-span-2 lg:col-span-1 lg:row-start-1">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-slate-900 dark:text-white mb-4 tracking-tight leading-tight">
            ...
            <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 font-medium mb-4">
              {t('hero.role')}
            </p>

            <p className="text-lg text-slate-600 dark:text-slate-400 mb-6 sm:mb-8 max-w-2xl leading-relaxed">
              {t('hero.bio')}
            </p>
          </div>

          {/* Actions & Contacts */}
          <div className="col-span-1 lg:col-span-1 lg:row-start-2 flex flex-col justify-between w-full max-w-[208px] sm:w-60 sm:max-w-none aspect-[3/4] sm:aspect-auto sm:h-[320px] lg:aspect-auto lg:h-auto lg:justify-start gap-1.5 sm:gap-2.5 lg:gap-4">
            <a
          ...
          {/* Personal Photo */}
          <div className="col-span-1 lg:col-span-1 lg:row-start-1 lg:row-span-2 flex-shrink-0 flex flex-col items-center justify-start lg:self-start w-full">
